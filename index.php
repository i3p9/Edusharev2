		...
		<!-- /Backgound Image -->
			<div class="home-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							<h1 class="white-text">EduShare</h1>
							<p class="lead white-text">Learn and teach anytime anywhere.</p>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="section-header">
							...
							<p class="lead">We are an online teaching platform to help students learn from the comfort of their homes.</p>
						</div>
						...
						<div class="feature">
							...
							<div class="feature-content">
								...
								<p>Various online courses available taken by experienced teachers.</p>
							</div>
						</div>
						<!-- /feature -->
						...
						<div class="feature">
							...
							<div class="feature-content">
								<h4>Become an Educator at EduShare</h4>
								<p>Apply to teach as an EduShare instructor and help people learn from home in the subject you are skilled at.</p>
							</div>
						</div>
						<!-- /feature -->
						...
						<div class="feature">
							...
							<div class="feature-content">
								<h4>Community</h4>
								<p>Learn, chat and communicate with other members all around sharing knowledge.</p>
							</div>
						</div>
						<!-- /feature -->
					</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<p class="lead">Choose a course and start learning through online lectures and classroom.</p>
					</div>
				</div>
				<!-- /row -->
		...
		<div id="why-us" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						<h2>Why Edusite</h2>
						<p class="lead">EduShare provides oppurtunities to home tutors and private tutors and provide cheaper and more readily available education</p>
					</div>
					...
					<div class="col-md-4">
						<div class="feature">
							...
							<div class="feature-content">
								...
								<p>Teachers are selected on the basis of their past experience and merits. We have a strict review system for the instructors and specially set procedures to provide lectures.</p>
							</div>
						</div>
					</div>
					<!-- /feature -->
